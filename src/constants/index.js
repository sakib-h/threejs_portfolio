...
export const calculateSizes = (isSmallScreen, isMobile, isTablet) => {
    return {
        deskScale: isSmallScreen ? 0.05 : isMobile ? 0.06 : 0.065,
        deskPosition: isMobile ? [0.5, -4.5, 0] : [0.25, -5.5, 0],
        cubePosition: isSmallScreen
            ? [4, -5, 0]
            : isMobile
            ? [5, -5, 0]
            : isTablet
            ? [5, -5, 0]
            : [9, -5.5, 0],
        reactLogoPosition: isSmallScreen
            ? [3, 4, 0]
            : isMobile
            ? [5, 4, 0]
            : isTablet
